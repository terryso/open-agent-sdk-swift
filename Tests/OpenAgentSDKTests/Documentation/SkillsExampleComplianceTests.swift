...
final class SkillsExampleComplianceTests: XCTestCase {
    ...
    func testSkillsExampleImportsOpenAgentSDK() throws {
    ...
    func testSkillsExampleImportsFoundation() throws {
        let content = try DocumentationTestHelpers.requireFileContent(examplePath())
        XCTAssertTrue(
    ...
    func testSkillsExampleCreatesSkillRegistry() throws {
        let content = try DocumentationTestHelpers.requireFileContent(examplePath())
        XCTAssertTrue(
    ...
    func testSkillsExampleRegistersAllBuiltInSkills() throws {
        let content = try DocumentationTestHelpers.requireFileContent(examplePath())
    ...
    func testSkillsExampleRegistersBuiltInSkillsIntoRegistry() throws {
        let content = try DocumentationTestHelpers.requireFileContent(examplePath())
        XCTAssertTrue(
    ...
    func testSkillsExampleOutputsAllRegisteredSkills() throws {
        let content = try DocumentationTestHelpers.requireFileContent(examplePath())
        XCTAssertTrue(
    ...
    func testSkillsExamplePrintsSkillNameDescriptionAndAliases() throws {
        let content = try DocumentationTestHelpers.requireFileContent(examplePath())
    ...
    func testSkillsExampleOutputsUserInvocableSkills() throws {
        let content = try DocumentationTestHelpers.requireFileContent(examplePath())
        XCTAssertTrue(
    ...
    func testSkillsExampleDemonstratesFilteringDifference() throws {
        let content = try DocumentationTestHelpers.requireFileContent(examplePath())
    ...
    func testSkillsExampleRegistersCustomSkill() throws {
        let content = try DocumentationTestHelpers.requireFileContent(examplePath())
    ...
    func testSkillsExampleCustomSkillHasPromptTemplate() throws {
        let content = try DocumentationTestHelpers.requireFileContent(examplePath())
        XCTAssertTrue(
    ...
    func testSkillsExampleCustomSkillHasAliases() throws {
        let content = try DocumentationTestHelpers.requireFileContent(examplePath())
    ...
    func testSkillsExampleCustomSkillAppearsInAllSkills() throws {
        let content = try DocumentationTestHelpers.requireFileContent(examplePath())
    ...
    func testSkillsExampleDemonstratesFindByName() throws {
        let content = try DocumentationTestHelpers.requireFileContent(examplePath())
        XCTAssertTrue(
    ...
    func testSkillsExampleDemonstratesFindByAlias() throws {
        let content = try DocumentationTestHelpers.requireFileContent(examplePath())
    ...
    func testSkillsExampleCreatesAgentWithSkillTool() throws {
        let content = try DocumentationTestHelpers.requireFileContent(examplePath())
        XCTAssertTrue(
    ...
    func testSkillsExampleAppendsSkillToolToTools() throws {
        let content = try DocumentationTestHelpers.requireFileContent(examplePath())
        XCTAssertTrue(
    ...
    func testSkillsExampleCreatesAgentWithOptions() throws {
        let content = try DocumentationTestHelpers.requireFileContent(examplePath())
        XCTAssertTrue(
    ...
    func testSkillsExamplePassesToolsIncludingSkillTool() throws {
        let content = try DocumentationTestHelpers.requireFileContent(examplePath())
        XCTAssertTrue(
    ...
    func testSkillsExampleUsesBypassPermissions() throws {
        let content = try DocumentationTestHelpers.requireFileContent(examplePath())
        XCTAssertTrue(
    ...
    func testSkillsExampleSendsQueryToAgent() throws {
        let content = try DocumentationTestHelpers.requireFileContent(examplePath())
        XCTAssertTrue(
    ...
    func testSkillsExamplePrintsAgentResponse() throws {
        let content = try DocumentationTestHelpers.requireFileContent(examplePath())
    ...
    func testSkillsExamplePrintsQueryStatistics() throws {
        let content = try DocumentationTestHelpers.requireFileContent(examplePath())
    ...
    func testSkillsExampleUsesLoadDotEnvPattern() throws {
        let content = try DocumentationTestHelpers.requireFileContent(examplePath())
        XCTAssertTrue(
    ...
    func testSkillsExampleUsesGetEnvPattern() throws {
        let content = try DocumentationTestHelpers.requireFileContent(examplePath())
        XCTAssertTrue(
    ...
    func testSkillsExampleDoesNotExposeRealAPIKeys() throws {
        let content = try DocumentationTestHelpers.requireFileContent(examplePath())
    ...
    func testSkillsExampleHasTopLevelDescriptionComment() throws {
        let content = try DocumentationTestHelpers.requireFileContent(examplePath())
    ...
    func testSkillsExampleHasMultipleInlineComments() throws {
        let content = try DocumentationTestHelpers.requireFileContent(examplePath())
    ...
    func testSkillsExampleHasMarkSections() throws {
        let content = try DocumentationTestHelpers.requireFileContent(examplePath())
    ...
    func testSkillsExampleDoesNotUseForceUnwrap() throws {
        let content = try DocumentationTestHelpers.requireFileContent(examplePath())
        let lines = content.components(separatedBy: "\n")
        for line in lines {
    ...
    func testSkillsExampleUsesRealSkillStructInit() throws {
        let content = try DocumentationTestHelpers.requireFileContent(examplePath())
    ...
    func testSkillsExampleUsesRealQueryResultProperties() throws {
        let content = try DocumentationTestHelpers.requireFileContent(examplePath())
    ...
    func testSkillsExampleUsesAwaitForPrompt() throws {
        let content = try DocumentationTestHelpers.requireFileContent(examplePath())
        XCTAssertTrue(
